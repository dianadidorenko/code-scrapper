      ...
      <div className="flex shadow-md my-10">
            ...
            >
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  ...
                  <span className="text-red-500 text-xs">Apply</span>
                  <span
        ...
        <div>
          ...
          <div>
            ...
            <div className="bg-indigo-500 font-semibold hover:bg-indigo-600 text-sm text-white uppercase w-full p-2 rounded-md text-center">
              <AddAddress />
            </div>
          </div>
        </div>
